...
const ROLE_META: Record<AppUser['role'], { chip: string }> = {
  ...
  Comptable: { chip: 'border-teal-200 dark:border-teal-500/20 bg-teal-50 dark:bg-teal-500/10 text-teal-700 dark:text-teal-400' },
  Acheteur: { chip: 'border-indigo-200 dark:border-indigo-500/20 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400' },
