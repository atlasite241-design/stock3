...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    steps: [
      { path: { fr: 'Catalogue › Catégories · Marques · Unités', ar: 'الكتالوج › الفئات · العلامات · الوحدات' }, desc: { fr: 'Compléter le référentiel du catalogue.', ar: 'إكمال مرجع الكتالوج.' } },
      { path: { fr: 'Catalogue › Produits', ar: 'الكتالوج › المنتجات' }, desc: { fr: 'Créer ou importer les articles : **prix d’achat HT**, prix de vente, stock minimum.', ar: 'إنشاء أو استيراد الأصناف: **سعر الشراء**، سعر البيع، الحد الأدنى للمخزون.' } },
      { path: { fr: 'Catalogue › Codes-barres', ar: 'الكتالوج › الرموز الشريطية' }, desc: { fr: 'Générer les EAN-13 manquants, imprimer les étiquettes Zebra, tester la douchette.', ar: 'توليد رموز EAN-13 الناقصة، طباعة ملصقات Zebra، اختبار الماسح.' } },
      { path: { fr: 'Stock › Initialisation › Stock initial', ar: 'المخزون › المخزون الأولي' }, desc: { fr: 'Saisir les quantités de départ (manuel, scan+quantité, scan répétitif ou **import Excel/CSV**), choisir le **dépôt**, contrôler la **valeur du stock**, puis **Valider**.', ar: 'إدخال الكميات الأولية (يدوي، مسح+كمية، مسح متكرر أو **استيراد Excel/CSV**)، اختيار **المستودع**، مراقبة **قيمة المخزون**، ثم **تأكيد**.' } },
